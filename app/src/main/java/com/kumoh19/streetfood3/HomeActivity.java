...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_home, R.id.navigation_category, R.id.navigation_ranking, R.id.navigation_add, R.id.navigation_mypage)
                .build();
        ...
        //firebase 정의
        mDatabase = FirebaseDatabase.getInstance("https://streetfood3-a8eab-default-rtdb.firebaseio.com/").getReference();
        readUser();
